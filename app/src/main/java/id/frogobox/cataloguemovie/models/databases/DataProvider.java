...
import id.frogobox.cataloguemovie.models.databases.DataContract.DataEntry;
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (match) {
            ...
            case DATA_ID:
                ...
                selection = DataEntry.COLUMN_MOVIE_ID + "=?"; // Where ID = "?"
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case DATA:
                ...
                break;
            case DATA_ID:
                selection = DataEntry.COLUMN_MOVIE_ID + "=?";
                selectionArgs = new String[] { String.valueOf(ContentUris.parseId(uri)) };
                rowsDeleted = database.delete(DataEntry.TABLE_NAME, selection, selectionArgs);
                break;
            default:
